...
/**
 * A <code>InheritableThreadLocal</code>-based implementation of {@link TenantContextHolderStrategy}.
 */
public class InheritableThreadLocalTenantContextHolderStrategy implements TenantContextHolderStrategy {
